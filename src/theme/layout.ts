...
export const layout = StyleSheet.create({
  ...
  // The tray and bottom navigation participate in layout, so the page only needs a small closing gutter.
  content: { paddingBottom: 18, paddingHorizontal: 2, paddingTop: 8 },
